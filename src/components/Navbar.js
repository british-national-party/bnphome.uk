      ...
      <Navbar color="#630a16" dark expand="md" fixed="top">
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="mr-auto" navbar>
            ...
            <NavItem>
              <a href="https://forms.bnp.org.uk/form-5284536/membership" className="nav-link">Membership</a>
            </NavItem>
            <NavItem>
              <a href="https://forms.bnp.org.uk/form-5286789/donation" className="nav-link">Donate</a>
            </NavItem>
            <NavItem>
              <a href="https://forms.bnp.org.uk/form-5306742/contact-us" className="nav-link">Contact Us</a>
            </NavItem>
